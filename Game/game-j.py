...
def read_data(filepath="./data/data.txt"):
    words = []
...
def run():
        # chosen_word == cw
        #chosen_word_list == cwl
        #chosen_word_list_underscores == cwlu
        #letter_index_dict == lid
    data = read_data(filepath="./data/data.txt")
    cw = random.choice(data)
    cwl = [letter for letter in cw]
    cwlu = ["_"] * len(cwl)
    lid = {}
    for idx, letter in enumerate(cw):
        if not lid.get(letter): 
            lid[letter] = []
        lid[letter].append(idx)     
...
---------------------------------------------------------------------------------------""")                                                                                                             
            print("¡Felicitaciones! Lo lograste. La palabra era: ", cw)
